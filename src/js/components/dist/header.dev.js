...
new _BtnRepeat["default"](
  "#modal-login .btn-repeat",
  "#modal-login .btn-login-hash"
);
new _BtnRepeat["default"](
  "#modal-signin .btn-repeat",
  "#modal-signin .btn-reg-hash"
);
new _BtnRepeat["default"](
  "#modal-forgot .btn-repeat",
  "#modal-forgot .btn-hash-forgot"
);
...
var confirmRegister = new _ConfirmPassword["default"](
...
var validateRegHash = new _Validation["default"](
  '#modal-signin [data-page="0"]'
);
...
$("body").on("click", "#modal-signin .btn-signin", function () {
  ...
  (0, _login.reg_gen)(data)
    .then(function (data) {
      console.log(data);
      document.cookie = "token="
        .concat(data.token, "; path=/; max-age=")
        .concat(60 * 60 * 24 * 3, ";");
...
var confirmLogin = new _ConfirmPassword["default"](
...
var validateLoginHash = new _Validation["default"](
  '#modal-login [data-page="0"]'
);
var loginData = {
...
var validateHashForgot = new _Validation["default"](
  '#modal-forgot [data-page="0"]'
);
var confirmForgot = new _ConfirmPassword["default"](
...
$("body").on("click", "#modal-forgot .btn-forgot", function () {
  ...
  (0, _login.recovery_password)(data)
    .then(function (data) {
      console.log(data);
