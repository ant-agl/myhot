...
if (isset($_POST['id_hotel']) and isset($_POST['id_room']) and isset($_POST['adults']) and isset($_POST['children']) and isset($_POST['input_date']) and isset($_POST['output_date']) and isset($_POST['night'])) {
	...
	if ($user_auth_data) {
		...
		$str = json_encode($arr); 
	    $ch = curl_init();
	    curl_setopt($ch, CURLOPT_URL, 'http://127.0.0.1:9088/api/v1/db/search/namespaces/reserve_temp/items?format=json&precepts=id=serial()');
